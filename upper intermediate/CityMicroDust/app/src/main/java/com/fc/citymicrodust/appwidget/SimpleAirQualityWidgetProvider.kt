...
class SimpleAirQualityWidgetProvider : AppWidgetProvider() {
    ...
    // 위젯에서 정보를 보여줄 서비스 클래스
    class UpdateWidgetService : LifecycleService() {

        // 서비스 생성시 채널을 생성해야함함  https://github.com/Kim-Min-Jong/android_practice_project2/tree/intermediate/intermediate/PushAlarmReciever#setting  (notification)
        ...
        override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            ...
            if (ActivityCompat.checkSelfPermission(
                ...
                val updateViews = RemoteViews(packageName, R.layout.widget_simple).apply {
                    ...
                    setViewVisibility(R.id.gradeTextView, View.GONE)
                }
                        ...
                        try {
                            ...
                            val updateViews =
                                RemoteViews(packageName, R.layout.widget_simple).apply {
                                    ...
                                    setViewVisibility(R.id.gradeTextView, View.VISIBLE)
